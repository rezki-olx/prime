...
gulp.task('microsite', [], cb => {
  runSequence(
    ['assets', 'pages', 'templates', 'images', 'metadata'],
    cb);
});
...
function watch() {
  ...
  gulp.watch(['src/**/*.{scss,css}'],                   ['styles', 'styles-grid', 'styletemplates', reload]);
...
gulp.task('templates', [
  'templates:localtestingoverride',
  'templates:images',
  'templates:fonts',
  'templates:styles'
]);
